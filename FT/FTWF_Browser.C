{
   ...
   TFile *ftFile = new TFile("/global/u1/j/jgruszko/software/FT_Histograms/FTWaveforms_pulsetube.root");
   TTree* FTTree = (TTree*)ftFile->Get("FTTree");

   FTTree->AddFriend("MGTree", "$MJDDATADIR/surfprot/data/built/P3AKF/OR_run40002478.root");
   FTTree->AddFriend("mjdTree","$MJDDATADIR/surfprot/data/gatified/P3AKF/mjd_run40002478.root");
